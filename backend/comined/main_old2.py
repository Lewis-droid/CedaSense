...
def continuous_monitoring():
    """Main monitoring loop - runs email checker continuously"""
    global last_submission_count, last_extracted_count
    
    print("[STARTUP] Initializing continuous monitoring...")
    
    # Initial counts
    last_submission_count = count_submission_folders()
    last_extracted_count = count_extracted_folders()
    
    print(f"[STARTUP] Current submissions: {last_submission_count}, extracted: {last_extracted_count}")
    ...
    # Start web server in background (simulated)
